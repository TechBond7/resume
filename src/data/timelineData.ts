...
export const timelineData: Array<ITimeline> = [
  {
    ...
    stack:
      ".NET 6+, .NET MAUI, EF Core 6+ (Code/Model First), LINQ, Fluent API, Fluent Validation, Swagger UI, C# 10+, xUnit, Selenium, Razor, Blazor, XAML, WPF, UWP, Xamarin.Forms, Docker, YAML, Javascript, Typescript, jQuery, SQL Server, Stored Procedures, Triggers, DBeaver, Visual Studio Code, Visual Studio, Git, Azure DevOps, Windows Terminal, Powershell Core, Domain Driven Design, Clean Architecture, Model View Controller, Model View ViewModel, Unit of Work...",
    tasks: [
