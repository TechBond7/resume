...
export const timelineData: Array<ITimeline> = [
    ...
    },
    {
        ...
        stack: ".NET 6+, EF Core 6+, LINQ, Fluent API, Swagger UI, C# 10+, xUnit, SonarQube, Kafka, RabbitMQ, Hangfire, Redis, ElasticSearch, Kibana, Docker, Kubernetes, YAML, Vue 3 (Composition API, Vite, PrimeVue 3, Pinia, Typescript, MySQL, Oracle, DBeaver, Git, Azure DevOps, Domain Driven Design, Clean Architecture...",
        tasks: ["1. Tasks related to the development of certain modules of a microservice based enterprise management platform for an emerging national IT company.", "2. Bug fixing of the aforementioned platform.", "3. Pull request management.", "4. Code coverage with unit tests.", "5. Agile development."]
    },
    {
        icon: "pi pi-code",
        what: "Ibermática S.A.",
